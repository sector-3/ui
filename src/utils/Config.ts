...
export const config = {
  ...
  daoFactoryAddress: (chain == 'mainnet') ? '0x7d480f3a2B5F8f45CbAbe8c0833924549dd1eB12' : ((chain == 'sepolia') ? '0x293aEF46130ca53868b27E3716D1DB653918d137' : '0xE6dc5d73B7E3764C42A4A71C408E4F8246f034f7'),
